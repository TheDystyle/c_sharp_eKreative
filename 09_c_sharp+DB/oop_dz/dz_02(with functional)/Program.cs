...
namespace dz_02_with_functional_
{
    internal class Program
    {
        ...
        static int CreateOrDefault()
        {
            ...
            Console.WriteLine("Do you want create new DB or use the default?");
        ...
        static void InsertData(SQLiteConnection conn)
        {
            ...
            sqlite_cmd.ExecuteNonQuery();
            sqlite_cmd.CommandText = "INSERT INTO cars(manufacturer, model, year_production, id_clients) VALUES(12, 'Audi', 'TT', 2000, 1); ";
            sqlite_cmd.ExecuteNonQuery();
